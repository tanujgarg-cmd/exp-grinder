    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ margin: "20px 0", textAlign: "center", position: "relative" }}>
          ...
          <span style={{
            position: "relative", top: -10, background: "#0a0a2a",
            padding: "0 12px", color: "#555", fontSize: "0.75rem",
          }}>or</span>
        </div>

        <button onClick={handleGoogleLogin} style={{
          width: "100%", padding: 14, borderRadius: 8, cursor: "pointer",
          background: "#05050f", border: "1px solid #1a1a3e", color: "#ccc",
          fontSize: "0.9rem", fontFamily: "'Share Tech Mono', monospace",
